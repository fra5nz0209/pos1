              ...
              <div class="card">
                ...
                <!--=====================================
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevaVenta" name="nuevaVenta" placeholder="Ingrese el numero de factura" required>
        ...
        <div class="col-lg-7 hidden-md hidden-xs hidden-sm">
          ...
          <div class="card card-warning">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-hover dt-responsive tablaVentas tbody">
