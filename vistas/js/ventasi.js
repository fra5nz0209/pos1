...
$.ajax({
	...
	url: "ajax/datatable-ventasi.ajax.php",
...
$('.tablaVentasi').DataTable( {
    "ajax": "ajax/datatable-ventasi.ajax.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaVentasi tbody").on("click", "button.agregarProducto", function(){
...
$(".tablaVentasi").on("draw.dt", function(){
...
function quitarAgregarProductoi(){

//Capturamos todos los id de productos que fueron elegidos en la venta
var idProductos = $(".quitarProducto");

//Capturamos todos los botones de agregar que aparecen en la tabla
var botonesTabla = $(".tablaVentasi tbody button.agregarProducto");
...
$(".formularioVentaInterna").on("click", "button.quitarProducto", function(){
...
$(".formularioVentaInterna").on("change", "select.nuevaDescripcionProducto", function(){
...
$(".formularioVentaInterna").on("change", "input.nuevaCantidadProducto", function(){
...
$(".formularioVentaInterna").on("change", "input.nuevoPrecioProducto", function(){
...
$(".formularioVentaInterna").on("change", "input.nuevoDescuentoProducto", function(){
...
function sumaArrayPrecios1(total, numero){
...
var sumaTotalPrecio = arraySumaPrecio.reduce(sumaArrayPrecios1);
...
$(".tablas").on("click", ".btnEditarVentai", function(){

var idVenta = $(this).attr("idVenta");

window.location = "index.php?ruta=editar-ventai&idVenta="+idVenta;
...
=============================================*/
$(".tablas").on("click", ".btnEliminarVentai", function(){
...
window.location = "index.php?ruta=ventasi&idVenta="+idVenta;
}
...
// $(".btnCambiarEstadoi").click(function(){
//   var idVenta = $(this).attr("idVenta");
